...
Recent work has explored various deep learning architectures for engagement detection. Savchenko et al.~\citep{savchenko2022emotions} proposed a deep learning framework for student engagement classification in online learning environments. Nezami et al.~\citep{nezami2020automatic} developed a video-based platform integrating emotion detection to increase online learning engagement. Kaur and Kaur~\citep{kaur2022review} applied CNN-based facial expression recognition for engagement evaluation in classroom settings. Yu et al.~\citep{yu2024bridging} investigated engagement and attention level detection on the DAiSEE dataset using various deep learning approaches.
...
Savchenko et al.~\citep{savchenko2022emotions} & 67.1 & 23.5 & 2022 \\
\midrule
