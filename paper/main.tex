...
Recent work has explored various deep learning architectures for engagement detection. Savchenko et al.~\citep{savchenko2022emotions} proposed a single facial expression recognition network for classifying emotions and engagement in online learning. Nezami et al.~\citep{nezami2020automatic} demonstrated automatic recognition of student engagement using deep learning and facial expressions. Kaur and Kaur~\citep{kaur2022review} provided a comprehensive review of machine learning and deep learning approaches for engagement detection. Yu et al.~\citep{yu2024bridging} systematically reviewed automated emotion recognition in online learning environments.
...
MobileNetV3 introduces the inverted residual block with squeeze-and-excitation (SE) attention~\citep{howard2019mobilenetv3}. Each block consists of: (1) a 1$\times$1 convolution for channel expansion; (2) a depthwise convolution for spatial filtering; (3) a squeeze-and-excitation block for channel attention; and (4) a 1$\times$1 convolution for channel projection.
